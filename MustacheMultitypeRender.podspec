...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "Render Mustache templates to any type. String and NSAttributedString rendering comes out of the box."
  ...
  s.resource_bundles = {
    'MustacheMultitypeRender' => ['Pod/Assets/*.png']
  }
